...
export default function Header() {
  ...
  return (
    <header className="fixed w-full top-0 z-50 bg-[#141414] text-white border-b border-white/10 shadow-lg">
      <div className="max-w-[1300px] mx-auto px-[15px] h-[90px] flex items-center justify-between">
        ...
        {/* Desktop Nav */}
        <nav className="hidden xl:flex items-center gap-6 2xl:gap-8 font-heading font-medium text-[15px] uppercase tracking-wide">
          <NavLink to="/" className={({ isActive }) => `whitespace-nowrap ${isActive ? "text-theme transition-colors" : "hover:text-theme transition-colors"}`}>Home</NavLink>
          <NavLink to="/profile" className={({ isActive }) => `whitespace-nowrap ${isActive ? "text-theme transition-colors" : "hover:text-theme transition-colors"}`}>Profile</NavLink>
          <NavLink to="/why-construction" className={({ isActive }) => `whitespace-nowrap ${isActive ? "text-theme transition-colors" : "hover:text-theme transition-colors"}`}>Why Construction</NavLink>
          <NavLink to="/experience" className={({ isActive }) => `whitespace-nowrap ${isActive ? "text-theme transition-colors" : "hover:text-theme transition-colors"}`}>Experience</NavLink>
          <NavLink to="/skills" className={({ isActive }) => `whitespace-nowrap ${isActive ? "text-theme transition-colors" : "hover:text-theme transition-colors"}`}>Skills</NavLink>
          <NavLink to="/qualifications" className={({ isActive }) => `whitespace-nowrap ${isActive ? "text-theme transition-colors" : "hover:text-theme transition-colors"}`}>Qualifications</NavLink>
